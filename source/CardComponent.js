...
class CardComponent extends HTMLElement {
   ...
   constructor() {
      ...
      const uprightMeanings = this.getAttribute("uprightMeanings")
      const reversedMeanings = this.getAttribute('reversedMeanings')
      const keywords = this.getAttribute("keywords")
      const symbolism = this.getAttribute("symbolism")
